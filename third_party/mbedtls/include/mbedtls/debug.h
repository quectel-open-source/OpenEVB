...
//#define MBEDTLS_SSL_DEBUG_MSG( level, args )            do { LogInfo(((const char *)args));} while( 0 )
//#define MBEDTLS_SSL_DEBUG_RET( level, text, ret )       do { LogInfo(((const char *)text));} while( 0 )
//#define MBEDTLS_SSL_DEBUG_BUF( level, text, buf, len )  do { LogInfo(((const char *)text));} while( 0 )
//#define MBEDTLS_SSL_DEBUG_MPI( level, text, X )         do { LogInfo(((const char *)text));} while( 0 )
//#define MBEDTLS_SSL_DEBUG_ECP( level, text, X )         do { LogInfo(((const char *)text));} while( 0 )
//#define MBEDTLS_SSL_DEBUG_CRT( level, text, crt )       do { LogInfo(((const char *)text));} while( 0 )
//#define MBEDTLS_SSL_DEBUG_ECDH( level, ecdh, attr )     do { LogInfo(((const char *)ecdh));} while( 0 )
